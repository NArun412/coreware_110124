...
class ProductCategoryGroupMaintenancePage extends Page {
	...
	function massageDataSource() {
		...
		$this->iDataSource->addColumnControl("product_category_group_departments", "form_label", "Departments");
		$this->iDataSource->addColumnControl("product_category_group_departments", "control_table", "product_departments");
