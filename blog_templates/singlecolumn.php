...
class ThisPage extends Page {
	...
	function setup() {
		...
		if (!empty($this->iPostId)) {
			...
			$GLOBALS['gPageRow']['meta_keywords'] = $categories;
			$GLOBALS['gPageRow']['meta_description'] = $postRow['title_text'];
		}
	}
	...
	function internalCSS() {
        ...
        <style>
            ...
            .blog-block p, .blog-detail-block p {
                padding: 0;
                margin: 0;
                padding-bottom: 10px;
                font-size: .8rem;
	...
	function jqueryTemplates() {
        ...
        <div id="_blog_entry_block">
            <div class="blog-block" data-minimum_width="768" id="blog_block_%post_id%">
                ...
                <p><span class="blog-date">%publish_date%</span></p>
                <p><img class="excerpt-image" %src%="%image_url%" alt="%title_text%"/></p>
                <p class="blog-body">%excerpt%</p><!-- blog-body -->
                <div class="button-block"><a class='button' href="%blog_link%">Read More</a></div>
                <div class='clear-div'></div>
            </div><!-- blog-block -->
