...
class ThisPage extends Page {
	...
	function headerIncludes() {
		...
		if (!empty($this->iPostId)) {
			...
			$linkUrl = (empty($urlAliasTypeCode) || empty($this->iProductRow['link_name']) ? "blog?post_id=" . $this->iPostId : $urlAliasTypeCode . "/" . $postRow['link_name']);
	...
	function mainContent() {
		...
		<?php if (empty($this->iPostId)) { ?>
            <div id="_blog_entries" class="slider-for"></div>
	...
	function javascript() {
        ...
        <script>
            ...
            function showMorePosts() {
                ...
                loadAjaxRequest("/blogcontroller.php?ajax=true&url_action=get_more&blog_count=" + blogCount + "&displayed=" + displayed + "&search_text=" + encodeURIComponent("<?= str_replace('"', '', $_GET['search_text']) ?>") +
