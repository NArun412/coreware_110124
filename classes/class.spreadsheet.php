...
class Spreadsheet extends MaintenancePage {
	...
	function mainContent() {
		?>
        <form id='_spreadsheet_form' name='_spreadsheet_form'>
	...
	function pageJavascript() {
        ...
        <script>
            function saveChanges(afterFunction, regardlessFunction) {
                ...
                if ($("#_spreadsheet_form").validationEngine("validate")) {
                    loadAjaxRequest("<?= $GLOBALS['gLinkUrl'] ?>?ajax=true&url_page=spreadsheet&url_action=save_changes", $("#_spreadsheet_form").serialize(), function(returnArray) {
	...
	function saveChanges() {
		...
		foreach ($_POST as $fieldName => $fieldData) {
			if (startsWith($fieldName, "primary_id-")) {
